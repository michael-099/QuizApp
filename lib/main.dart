...
class MyAppState extends State<MyApp> {
  ...
  var question = [
    ...
    },
    {
      ...
      'ans': [
        {"text":"The value of the variable cannot be changed after it is initialized" , "score": 2},
        {"text":"The variable must be initialized with a value when it is declared" , "score": 0},
        {"text":" The variable can only be used within the same file where it is declared", "score": 0},
        {"text":"The variable can be null", "score": 0},
      ]
    },
    {
      'Question': "What is the correct syntax for declaring a variable in Dart?",
      'ans': [
    ...
    {
      'Question': "What is the correct syntax for a conditional statement in Dart?",
      'ans': [
        {"text":"if(condition) { // code to execute };" , "score": 2},
        {"text":"b) while(condition) { // code to execute };" , "score": 0},
        {"text":"c) for(var i = 0; i < 10; i++) { // code to execute };" , "score": 0},
        {"text":") switch(variableName) { case value: // code to execute; break; }" , "score": 0},
      ]
    },
    {
    ...
    {
      'Question': "Which of the following is a valid way to declare a list in Dart?",
      'ans': [
